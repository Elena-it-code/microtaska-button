...
function App() {
    ...
    function addTask(todolistID: string, title: string) {
        ...
        /*setTasks({...tasks,[todolistID]:[...tasks [todolistID],newTask]})*/ //добавляются новые task(и) внизу
        setTasks({...tasks,[todolistID]:[newTask, ...tasks [todolistID]]}) //добавляются новые task(и) вверху
